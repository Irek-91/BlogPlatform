...
exports.securityDeviceController = new securityDevice_router_1.SecurityDeviceController(securityDeviceService);
exports.authController = new auth_1.AuthController(usersService, exports.tokensService, authService);
exports.usersController = new users_router_1.UsersController(usersService);
exports.commentsController = new comments_router_1.CommentsController(commentsService);
exports.postsController = new posts_router_1.PostsController(postsService, blogsService, commentsService);
exports.blogsController = new blogs_router_1.BlogsController(blogsService, postsService);
